...
Game::Game(int p_count, long long init_chip, const vector<AIType>& ai_types) {
    for (int i = 0; i < p_count; ++i) {
        players.push_back(Player("Player_" + to_string(i), init_chip, ai_types[i]));
    }
    dealer_idx = 0;
    current_game = 0;
...
void Game::initSingleGame() {
    ...
    // --- ĐƯA PHẦN IN THÔNG BÁO NÀY LÊN ĐẦU ---
    cout << "\n========== VAN " << current_game + 1 << " ==========\n";
